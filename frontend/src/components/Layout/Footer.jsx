...
const Footer = () => {
  return (
    <>
      {/* FROSTED GLASS MARQUEE */}
      <div className="bg-white/40 backdrop-blur-md border-y border-white/60 py-4 overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.03)] relative z-20">
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center text-dairyBlack font-bold tracking-[0.2em] uppercase text-sm">
      ...
      <footer className="bg-white/30 backdrop-blur-xl text-dairyBlack pt-20 pb-10 border-t border-white/50 relative overflow-hidden shadow-[0_-10px_40px_rgba(0,0,0,0.04)]">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-dairyBlack rounded-full flex items-center justify-center shadow-[0_4px_15px_rgba(0,0,0,0.15)]">
                  <span className="text-white font-serif font-bold text-xl">SR</span>
                </div>
                <h3 className="text-3xl font-serif font-bold text-dairyBlack">Sita Ram</h3>
              </div>
            ...
            <div>
              <h4 className="text-xl font-serif font-bold mb-6 text-dairyBlack">Explore</h4>
            ...
            <div>
              <h4 className="text-xl font-serif font-bold mb-6 text-dairyBlack">Contact</h4>
            ...
            <div>
              <h4 className="text-xl font-serif font-bold mb-6 text-dairyBlack">Follow Us</h4>
              <div className="flex gap-4">
                <a href="#" aria-label="Facebook" className="w-10 h-10 bg-white/80 backdrop-blur border border-white text-dairyBlack rounded-full flex items-center justify-center hover:bg-dairyRed hover:text-white hover:border-dairyRed hover:-translate-y-1 transition-all duration-300 shadow-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                </a>
                <a href="#" aria-label="Instagram" className="w-10 h-10 bg-white/80 backdrop-blur border border-white text-dairyBlack rounded-full flex items-center justify-center hover:bg-dairyRed hover:text-white hover:border-dairyRed hover:-translate-y-1 transition-all duration-300 shadow-sm">
                  <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                </a>
                <a href="#" aria-label="YouTube" className="w-10 h-10 bg-white/80 backdrop-blur border border-white text-dairyBlack rounded-full flex items-center justify-center hover:bg-dairyRed hover:text-white hover:border-dairyRed hover:-translate-y-1 transition-all duration-300 shadow-sm">
          ...
          <div className="border-t border-gray-300 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-bold text-gray-500">
