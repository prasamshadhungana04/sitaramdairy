  ...
  return (
    <div className="bg-[#F9F6F0] min-h-screen py-24 px-6">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-serif font-bold text-[#a80000] mb-8">Order History</h1>
          ...
          {mockOrders.map(order => (
            <div key={order.id} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="flex items-center gap-6 w-full md:w-auto">
                <div className="w-16 h-16 bg-[#a80000]/5 rounded-xl flex items-center justify-center text-[#a80000]"><Package size={28} /></div>
                <div>
                  <p className="text-xl font-bold text-[#a80000] mb-1">{order.id}</p>
              ...
              <div className="flex items-center justify-between w-full md:w-auto gap-8">
                ...
                <button className="p-3 bg-gray-50 hover:bg-[#a80000] hover:text-white rounded-xl transition-colors text-gray-400"><ChevronRight size={20} /></button>
              </div>
            </div>
          ))}
        </div>
